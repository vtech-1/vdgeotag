...
function setupEventListeners() {
    ...
    // Only the service team files inspections (they're the ones visiting
    // sites), so Back always returns to their queue.
    on('backFromInspectionBtn', 'click', () => showPage('page-service'));
    on('insOpenCameraBtn',   'click', openInspectionCamera);
    on('insFlipCameraBtn',   'click', flipInspectionCamera);
    on('insCaptureBtn',      'click', captureInspectionPhoto);
    on('insConfirmPhotoBtn', 'click', confirmInspectionPhoto);
    on('insRetakeBtn',       'click', retakeInspectionPhoto);
