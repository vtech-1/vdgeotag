...
function submitRecord() {
    ...
    // serverNow() throughout: the date/time/shift here are what the user
    // sees locally. The authoritative values are re-stamped server-side in
    // handleSubmitReport(), so a wrong phone clock can't back-date a report.
    const now       = serverNow();
