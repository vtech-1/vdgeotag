...
const CACHE_NAME = 'vd-geotag-v31'; // bumped: service admin role + dashboard, two-way complaints (service/admin → supervisor), site inspections, incharge mobile, supervisor+date filters, free-text resolution modal, backend speed-ups
...
const CACHE_FILES = [
    ...
    './js/inspections.js', './js/service.js', './js/serviceadmin.js',
    './js/admin.js',       './js/navigation.js', './js/ui.js',
