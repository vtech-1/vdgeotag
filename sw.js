...
const CACHE_NAME = 'vd-geotag-v36'; // bumped: SECURITY — attendance/report times are now stamped server-side; a changed phone clock can no longer falsify a punch. Device clock skew is warned about and logged.
