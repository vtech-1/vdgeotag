...
const CACHE_NAME = 'vd-geotag-v35'; // bumped: visible GPS status on the inspection page (auto-fills location, live refresh), camera + timer released when leaving the page
